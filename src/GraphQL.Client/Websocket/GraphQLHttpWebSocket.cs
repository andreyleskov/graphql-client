...
namespace GraphQL.Client.Http.Websocket
{
    internal class GraphQLHttpWebSocket : IDisposable
    {
        ...
        public GraphQLHttpWebSocket(Uri webSocketUri, GraphQLHttpClient client, Func<Uri, CancellationToken,Task<WebSocket>>? connectedWebSocketFactory=null)
        {
            ...
            _connectedWebSocketFactory = connectedWebSocketFactory ?? (async (uri, token) =>
            {
#if NETFRAMEWORK
